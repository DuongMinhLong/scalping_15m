...
PROMPT_USER_MINI = (
    ...
    'Output JSON duy nhất: {"coins":[{"pair":"SYMBOL","entry":0.0,"sl":0.0,"tp":0.0,"risk":0.0,"expiry":0},...]}. '
    '"expiry" là số giây trước khi lệnh limit hết hạn (bot sẽ tự hủy nếu không khớp). '
